...
EVERYTHING_ON = dict(
    ...
    MCP_OWNER_PASSWORD="x" * 16, ENABLE_CONTACTS="true", ENABLE_REMINDERS="true", ENABLE_NOTES="true", ENABLE_DRIVE="true", ENABLE_MAPS="true", ENABLE_IMESSAGE="true", IMESSAGE_ALLOW_SEND="true",
