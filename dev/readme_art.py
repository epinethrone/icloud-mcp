...
<text x="640" y="556" text-anchor="middle" font-size="19" fill="{t['faint']}" letter-spacing="1.5">63 TOOLS  ·  ONE CONNECTOR  ·  RUNS ON YOUR OWN MACHINE</text>
""")
...
<g>
  ...
  {f'<text x="{x + 32}" y="{y + 254}" font-size="14" font-weight="600" fill="{t["faint"]}" letter-spacing="1.2">WITH THE MAC HELPER</text>' if mac else ''}
    ...
    return svg(w, h, "Six apps, one connector: Mail 20 tools, Calendar 8, Contacts 6, Reminders 6, Notes 9, iCloud Drive 10.", f"""
<rect width="{w}" height="{h}" rx="36" fill="{t['bg']}"/>
